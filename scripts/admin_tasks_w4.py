...
if __name__ == "__main__":
    ...
    branches = ["branch-Level-7", "branch-Level-8", "branch-Level-9", "branch-A-JavaDoc", "branch-A-CodingStandard"]
    ...
    for i in range(len(users)):
        ...
        if repo_made_pr_safe(parse_github_full_name(users[i][1]), repo, token):
            df.loc[df["Full Name"] == users[i][0], "PR Creation"] = '1'
            print("PR Creation done", users[i][0])
